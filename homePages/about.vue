<template>
 ...
 <view style="margin-left: 100rpx;padding-top:200rpx;">
	 <view class="plus-text">
	      <view class="tn-text-bold">初衷是给大家提供优秀的旅行攻略</view>
	      <view class="tn-margin-bottom-xl">如果你有好的想法希望你可以联系作者！</view>
	    </view>
		<view class="plus-text">
		  <view class="tn-text-bold">微信号：<text class="tn-text-bold tn-text-xxl">wang1302662981</text> </view>
		</view>
	    <view class="plus-text">
	      <view class="tn-text-bold">愿你在旅行生活中找到<text class="tn-text-bold tn-text-xxl">属于你的一份快乐！</text> </view>
	      <view class="">祝你玩得开心~~~</view>
	    </view>
 </view>
  </view>
</template>
