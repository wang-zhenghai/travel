<template>
  ...
  <view class="components-time-line">
    <!-- 顶部自定义导航 -->
    <tn-nav-bar fixed>查看物流</tn-nav-bar>
    <!-- 页面内容 -->
        ...
        expressData: [
          {
            info: '派送成功',
            status: 7,
            time: '2023-11-11 17:42'
          },
          {
            info: '[代收点] 您的快件已从XXX顺丰速运代理店取出〖来自代收点〗',
            status: 0,
            time: '2023-11-11 17:31'
          },
          {
            info: '快件领取成功',
            status: 0,
          ...
          },
          {
            info: '快件到达〖XXX合作点〗',
            status: 4,
            time: '2023-11-11 16:25'
          },
          {
            info: '快件在〖XXX营业点〗完成分拣，准备发往〖XXX合作点〗',
            status: 0,
            time: '2023-11-11 13:50'
          },
          {
            info: '快件到达〖XXX营业点〗',
            status: 0,
            time: '2023-11-11 13:06'
          },
          {
            info: '快件在〖XXX集散点〗完成分拣，准备发往〖XXX营业点〗',
            status: 0,
            time: '2023-11-11 12:04'
          },
          {
            info: '快件到达〖XXX集散点〗',
            status: 0,
          ...
          },
          {
            ...
            status: 0,
            time: '2023-11-11 05:52'
          },
          {
            info: '快件到达〖XXX转场〗',
            status: 0,
            time: '2023-11-11 05:36'
          },
          {
            info: '快件在〖XXX中转场〗完成分拣，准备发往〖XXX中转场〗',
            status: 0,
            time: '2023-11-10 23:36'
          },
          {
            info: '快件到达〖XXX中转场〗',
            status: 0,
          ...
          },
          {
            info: '包裹正在等待揽收',
            status: 1,
            time: '2023-11-10 17:41'
          },
          {
            info: '商品已经下单',
            status: 1,
            time: '2023-11-10 12:17'
          }
        ]
      }
    },
