<template>
	<view class="template-message">
		...
		<view class="tn-safe-area-inset-bottom tn-margin-bottom-sm" style="margin-top: 260rpx;"
			...
			<tn-swipe-action>
				<tn-swipe-action-item v-for="(item,index) in 1" :key="index" :name="index" :options="options">
							...
							<view class="tn-flex tn-flex-col-center tn-flex-row-left">
								...
								<view class="tn-padding-right tn-color-black">
									...
									<view
										...
										<text class="tn-color-grey">666</text>
									</view>
								</view>
							</view>
						</view>
